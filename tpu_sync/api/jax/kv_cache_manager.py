...
class KVCacheManager:
  ...
  def __init__(
    ...
    if backend_configs:
      self.register_kv_backends(backend_configs)

  def register_kv_backends(self, backend_configs: Sequence[Any]) -> None:
    """Registers secondary persistent storage on this worker."""
